...
namespace SanteDB.Messaging.HL7
{
	...
	public class AdtMessageHandler : IHL7MessageHandler
	{
		...
		/// </summary>
		private readonly TraceSource traceSource = new TraceSource("SanteDB.Messaging.HL7");
        ...
        public IMessage HandleMessage(Hl7MessageReceivedEventArgs e)
		{
			...
			try
			{
				if (e.Message.Version == "2.3.1" || e.Message.Version == "2.5")
				{
                    ...
                    // get the device identity by device name, as the device will have to be registered in SanteDB
