...
using SanteDB.Tools.DataQueryService.Wcf;
using System;
...
namespace SanteDB.Tools.DataQueryService
{
    /// <summary>
    /// Represents a daemon service that exports Swagger documentation
    /// </summary>
    [Description("Debugger: Data Query UI")]
    [TraceSource("SanteDB.Tools.DataQueryService")]
    public class DateQueryDebugService : IDaemonService
    {
        // HDSI Trace host
        ...
        public bool Start()
        {
            ...
            ApplicationContext.Current.Started += (o, e) =>
            {
                ...
                this.m_webHost = new WebServiceHost(typeof(QueryToolBehavior));
                this.m_webHost.Open();
