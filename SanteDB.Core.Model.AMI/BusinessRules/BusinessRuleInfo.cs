...
namespace SanteDB.Core.Model.AMI.BusinessRules
{
	/// <summary>
	/// Represents a business rules information wrapper.
	/// </summary>
	[XmlType(nameof(BusinessRuleInfo), Namespace = "http://santedb.org/ami")]
	[XmlRoot(nameof(BusinessRuleInfo), Namespace = "http://santedb.org/ami")]
