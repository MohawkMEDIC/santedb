...
namespace SanteDB.Core.Model.AMI.DataTypes
{
	/// <summary>
	/// Represents information about an assigning authority.
	/// </summary>
	[XmlType(nameof(AssigningAuthorityInfo), Namespace = "http://santedb.org/ami")]
	[XmlRoot(nameof(AssigningAuthorityInfo), Namespace = "http://santedb.org/ami")]
