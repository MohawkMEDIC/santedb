        ...
        return {
            ...
            link: function (scope, element, attrs, ctrl) {
                $timeout(function () {
                    ...
                    if (modelType != "SecurityUser" && modelType != "SecurityRole" && !filter.statusConcept)
                    ...
                    $(element).select2({
                        ...
                        ajax: {
                            url: baseUrl + ((modelType == "SecurityUser" || modelType == "SecurityRole") ? "/ami/" : "/imsi/") + modelType,
                            dataType: 'json',
                            delay: 500,
                            method: "GET",
                            headers: {
                                "Accept" : "application/json+oiz-viewmodel"
                            },
                            cache: false,
