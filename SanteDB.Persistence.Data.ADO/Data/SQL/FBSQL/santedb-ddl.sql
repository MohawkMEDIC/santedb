...
CREATE TABLE SEC_ROL_POL_ASSOC_TBL (
	...
	POL_ACT SMALLINT DEFAULT 0 NOT NULL CHECK (POL_ACT < 3), -- POLICY ACTIONS
...
CREATE TABLE SEC_DEV_POL_ASSOC_TBL (
	...
	POL_ACT SMALLINT NOT NULL CHECK (POL_ACT < 3), -- POLICY ACTION EITHER GRANT, DENY OR ELEVATE
...
CREATE TABLE SEC_APP_POL_ASSOC_TBL (
	...
	POL_ACT SMALLINT CHECK (POL_ACT < 3) NOT NULL, -- POLICY ACTION
...
CREATE TABLE ALRT_TBL (
	...
	FLAGS SMALLINT DEFAULT 0 NOT NULL, -- FLAGS OF THE MESSAGE
...
CREATE FUNCTION GET_SCH_VRSN() RETURNS VARCHAR(10) AS
BEGIN
	RETURN '1.0.0.0';
END!!
...
INSERT INTO SEC_USR_ROL_ASSOC_TBL (SEC_POL_INST_ID, ROL_ID, USR_ID) VALUES (gen_uuid(), char_to_uuid('c3ae21d2-fc23-4133-ba42-b0e0a3b817d7'), char_to_uuid('fadca076-3690-4a6e-af9e-f1cd68e8c7e8'));
...
INSERT INTO SEC_USR_ROL_ASSOC_TBL (SEC_POL_INST_ID, ROL_ID, USR_ID) VALUES (gen_uuid(), char_to_uuid('dadbd858-13c5-44a3-ad7d-1c44cecaa4b6'), char_to_uuid('C96859F0-043C-4480-8DAB-F69D6E86696C'));
